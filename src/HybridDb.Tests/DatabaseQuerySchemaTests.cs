...
namespace HybridDb.Tests
{
    public class DatabaseQuerySchemaTests : HybridDbTests
    {
        ...
        public void ReturnsAllTables(TableMode mode)
        {
            ...
            new CreateTable(new Table("Entities2", new Column("test", typeof(int)))).Execute(documentStore.Database);
        ...
        public void ReturnsAllColumns(TableMode mode)
        {
            ...
            new CreateTable(new Table("Entities1", new Column("test", typeof(int)))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeInt", typeof(int))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeBool", typeof(bool))).Execute(documentStore.Database);

            new CreateTable(new Table("Entities2", new Column("test", typeof(int)))).Execute(documentStore.Database);
            new AddColumn("Entities2", new Column("SomeString", typeof(string))).Execute(documentStore.Database);
        ...
        public void ColumnsHasTypeInfo(TableMode mode)
        {
            ...
            new AddColumn("Entities1", new Column("SomeInt", typeof(int))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeBool", typeof(bool))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeString", typeof(string))).Execute(documentStore.Database);
        ...
        public void ColumnsHasNullableInfo(TableMode mode)
        {
            ...
            new CreateTable(new Table("Entities1", new Column("test", typeof(int)))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeNullableInt", typeof(int?))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeString", typeof(string))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeInt", typeof(int))).Execute(documentStore.Database);
        ...
        public void ColumnsHasPrimaryKeyInfo(TableMode mode)
        {
            ...
            new AddColumn("Entities1", new Column("SomeString", typeof(string),  isPrimaryKey: false)).Execute(documentStore.Database);
        ...
        public void ColumnsHasDefaultValue(TableMode mode)
        {
            ...
            new AddColumn("Entities1", new Column("SomeNullableDecimal", typeof(decimal?), defaultValue: null)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeOtherNullableDecimal", typeof(decimal?), defaultValue: 42.42m)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeNullableGuid", typeof(Guid?), defaultValue: null)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeOtherNullableGuid", typeof(Guid?), defaultValue: new Guid("BAB0E469-DE94-4FDB-9868-968CA569E9A9"))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeNullableDateTime", typeof(DateTime?), defaultValue: null)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeOtherNullableDateTime", typeof(DateTime?), defaultValue: new DateTime(1999, 12, 24))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeNullableDateTimeOffset", typeof(DateTimeOffset?), defaultValue: null)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeOtherNullableDateTimeOffset", typeof(DateTimeOffset?), defaultValue: new DateTimeOffset(new DateTime(1999, 12, 24)))).Execute(documentStore.Database);

            new AddColumn("Entities1", new Column("SomeGuid", typeof(Guid), defaultValue: new Guid("BAB0E469-DE94-4FDB-9868-968CA569E9A9"))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeInt", typeof(int), defaultValue: 666)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeDecimal", typeof(decimal), defaultValue: 666.22m)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeDouble", typeof(double), defaultValue: 666.42)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeLong", typeof(long), defaultValue: 987654321987654312)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeString", typeof(string), defaultValue: "peter")).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeOtherString", typeof(string), defaultValue: null)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeBool", typeof(bool), defaultValue: true)).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeOtherBool", typeof(bool))).Execute(documentStore.Database);
            ...
            new AddColumn("Entities1", new Column("SomeDateTimeOffset", typeof(DateTimeOffset), defaultValue: new DateTimeOffset(new DateTime(1999, 12, 24)))).Execute(documentStore.Database);
            new AddColumn("Entities1", new Column("SomeEnum", typeof(SomeEnum), defaultValue: SomeEnum.SomeOtherValue)).Execute(documentStore.Database);
        ...
        public void CanHandleLegacyBooleanDefaultValues(TableMode mode)
        {
            ...
            documentStore.Database.RawExecute(string.Format("alter table {0} add [SomeFalseBool] Bit NOT NULL DEFAULT '0'", documentStore.Database.FormatTableNameAndEscape("Entities1")));
            documentStore.Database.RawExecute(string.Format("alter table {0} add [SomeTrueBool] Bit NOT NULL DEFAULT '1'", documentStore.Database.FormatTableNameAndEscape("Entities1")));
