...
namespace HybridDb.Migrations.Documents
{
    public class UpdateProjectionsMigration : RowMigrationCommand
    {
        ...
        public override SqlBuilder Matches(IDocumentStore store, int? version) => new SqlBuilder().Append("AwaitsReprojection = @AwaitsReprojection", new SqlParameter("AwaitsReprojection", true));
