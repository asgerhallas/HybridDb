...
namespace HybridDb.Migrations.Documents
{
    public class UpdateProjectionsMigration : RowMigrationCommand
    {
        ...
        public override SqlBuilder Matches(IDocumentStore store, int? version) => new SqlBuilder().Append("AwaitsMigration = @AwaitsMigration", new SqlParameter("AwaitsReprojection", true));
