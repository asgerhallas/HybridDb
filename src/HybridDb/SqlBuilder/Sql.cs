...
public class Sql
{
    ...
    public HybridDbParameters CustomParameters { get; } = new();
    ...
    public string Build(IDocumentStore store, out HybridDbParameters parameters)
    {
        ...
        var result = Build(store, parameters);

        foreach (var customParameter in CustomParameters.Parameters)
        {
    ...
    public static Sql From(SqlStringHandler handler) => Empty.Append(handler.fragments);
    public Sql Append(SqlStringHandler handler) => Append(handler.fragments);

    public static Sql From(SqlStringHandler handler, object param) => Empty.Append(handler, param);
    ...
    public static Sql From(string infix, Sql sql) => Empty.Append(infix, sql);
